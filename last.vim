...
set laststatus=2
set mouse=a
set runtimepath=~/.vim,~/.vim/plugged/vim-floaterm,~/share/vim/vimfiles,~/share/vim/vim90,~/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set smartindent
set statusline=%#Error#%3f\ %#StorageClass#\ Filetype:%4Y%{StatuslineGit()}\ %=%#StatusLineTerm#%#CursorLine#\ Percent:%p%%\ \ C/Line:%-3l\ T/L:%-4L\ Columns:%-2c\ 
set noswapfile
set tabstop=4
...
badd +0 SRCS/drawer.c
badd +0 SRCS/errors.c
badd +0 SRCS/logs.c
badd +0 SRCS/mandelbrot.c
argglobal
%argdel
$argadd .
set stal=2
...
wincmd w
argglobal
if bufexists(fnamemodify("~/Desktop/Fractol/SRCS/logs.c", ":p")) | buffer ~/Desktop/Fractol/SRCS/logs.c | else | edit ~/Desktop/Fractol/SRCS/logs.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 89 + 90) / 180)
tabnext
edit ~/Desktop/Fractol/SRCS/mandelbrot.c
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
lcd ~/Desktop/Fractol
tabnext
edit ~/Desktop/Fractol/SRCS/errors.c
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
lcd ~/Desktop/Fractol
tabnext
edit ~/Desktop/Fractol/SRCS/drawer.c
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
